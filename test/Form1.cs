...
namespace test
{
    ...
    public partial class Form1 : Form
    {
        ...
        public class DBConfig
        {
            ...
            public static string dbFile = System.Windows.Forms.Application.StartupPath + @"\log.db";
                ...
                for (int k = 0; k < this.chart1.Series["stocks"].Points.Count; k++)
{
        ...
        void manipulatePdf(String src)
        {
            ...
            table_ch_2.AddCell(new Paragraph(richTextBox1.Text));

            // 出貨統計資料 QR Code
            System.Drawing.Bitmap bitmap_2 = get_qrcode(richTextBox1.Text, pictureBox2.Width, pictureBox2.Height);
        ...
        private void Show_Statistic()
        {
            ...
            System.Drawing.Bitmap qr_code = get_qrcode(richTextBox1.Text, pictureBox2.Width, pictureBox2.Height);
